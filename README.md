# Employee-Owned Job Sites

[![Entries](https://img.shields.io/github/directory-file-count/olitreadwell/employee-owned-job-sites/data/entries?type=file&extension=yaml&label=entries&color=brightgreen)](GUIDE.md)
[![CI](https://github.com/olitreadwell/employee-owned-job-sites/actions/workflows/ci.yml/badge.svg)](https://github.com/olitreadwell/employee-owned-job-sites/actions/workflows/ci.yml)
[![Link check](https://github.com/olitreadwell/employee-owned-job-sites/actions/workflows/linkcheck.yml/badge.svg)](https://github.com/olitreadwell/employee-owned-job-sites/actions/workflows/linkcheck.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

A living, link-checked directory of job sites for employee-owned and cooperative employers.

## What this is

A living, link-checked directory of job sites for employee-owned and cooperative employers. Every entry is a small YAML
